...
export default function Cakes(){
    ...
    const cakesList = [
...

        {
            ...
            subheader:"Now you have your Favourite snicker chocolate in the cake form",
...
function getStyles(name, personName, theme) {
    ...
    return(
      ...
      <FormControl sx={{ m: 1, width: 300, display:'flex', justifyContent:'flex-end'}}>
        ...
        <Box sx={{backgroundColor:'#FF4E84'}} direction='row' display='flex' pt={5}>
        <h4>Connect with Us</h4>
        <FacebookIcon/>
        <InstagramIcon/>
        <LinkedInIcon/>
        </Box>
        <Box sx={{backgroundColor:'#FF4E84'}} display='flex' alignItems='center' pt={5} pb={10}>
