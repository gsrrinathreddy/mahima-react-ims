...
} from "../../features/chocolates/chocolateSlice";
...
export default function ViewCart() {
  ...
  const orderedprice = useSelector(
    (state) => state.cart.cartList.discountedPrice
  );
  ...
  let discountedPrice = useSelector(
    (state) => state.cake.cakesList.discountedPrice
  );
  ...
  let noOfChocolates = useSelector(
